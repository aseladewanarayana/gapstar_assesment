(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["resource/js/components/category/add"],{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.axios.post('/api/customer', _this.category).then(function (response) {
                  _this.$router.push({
                    name: "categoryList"
                  });
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.category.email,
                          expression: "category.email"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text" },
                      domProps: { value: _vm.category.email },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.category, "email", $event.target.value)
                        }
                      }
                    })
                  ])
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.category.firstname,
                          expression: "category.firstname"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text" },
                      domProps: { value: _vm.category.firstname },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.category.lastname,
                          expression: "category.lastname"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text" },
                      domProps: { value: _vm.category.lastname },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.category.phone,
                          expression: "category.phone"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text" },
                      domProps: { value: _vm.category.phone },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.category, "phone", $event.target.value)
                        }
                      }
                    })
                  ])
                ...
                _c("div", { staticClass: "col-12 mb-2" }, [
                  _c("div", { staticClass: "form-group" }, [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.category.mobile,
                          expression: "category.mobile"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text" },
                      domProps: { value: _vm.category.mobile },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.category, "mobile", $event.target.value)
                        }
                      }
                    }),
                    _vm._v(" "),
                    _c("input", {
                      ...
                      domProps: { value: _vm.category.status },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.category, "status", $event.target.value)
                        }
                      }
                    })
                  ])
