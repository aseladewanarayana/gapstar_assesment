              ...
              case 0:
                ...
                return _this.axios.get("/api/customer/".concat(_this.$route.params.id)).then(function (response) {
                  var _response$data = response.data,
                      ...
                      mobile = _response$data.mobile;
                  _this.customer.email = email;
                  _this.customer.firstname = firstname;
                  _this.customer.lastname = lastname;
                  _this.customer.phone = phone;
                  _this.customer.mobile = mobile;
                ...
                _c("div", { staticClass: "col-12 mb-2" }, [
                  _c("div", { staticClass: "form-group" }, [
                    ...
                    _c("input", {
                      ...
                      staticClass: "form-control",
                      attrs: { type: "text" },
                      domProps: { value: _vm.customer.mobile },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.customer, "mobile", $event.target.value)
                        }
                      }
                    })
                  ])
